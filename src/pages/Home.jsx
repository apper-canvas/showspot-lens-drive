...
const Home = () => {
  ...
  const EventCard = ({ event }) => {
    ...
    return (
      <motion.div 
        className="card overflow-hidden flex flex-col w-full sm:w-[calc(50%-0.5rem)] lg:w-[calc(33.333%-1rem)] xl:w-[calc(25%-1rem)]"
        ...
        <div className="p-4 flex flex-col flex-grow">
          ...
          <div className="mt-auto flex items-center justify-between">
            ...
            <button 
              ...
              onClick={() => toast.success(`Booking started for ${title}`)}
            >
              Book Now
            </button>
          </div>
